...
<form action="{{ route('AuthTambahProduk') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-2 gap-5 mt-10 justify-items-center bg-[#FFFCDA] px-20 py-10 rounded-3xl">
        ...
        <div class="w-full">
            <input type="text" name="harga" placeholder="Harga" class="w-full px-3 py-2 rounded-xl" required>
        </div>
        <div class="w-full">
            <input type="text" name="berat" placeholder="Berat" class="w-full px-3 py-2 rounded-xl" required>
        </div>
        <div class="w-full col-span-2">
